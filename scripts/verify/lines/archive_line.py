"""Verification: archiving line histories (design §5.7, D20).
...
_, a_token = admin.register_agent(a_name, "dummy", "verify agent A")
_, b_token = admin.register_agent(b_name, "dummy", "verify agent B")
