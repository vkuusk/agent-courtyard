"""Verification: hub memory, slice 4 — export and retention (design hub-memory.md
sections 6 and 8).
...
for key, domain in (
    ...
    _, tokens[key] = admin.register_agent(names[key], "dummy", f"verify {key}", domain)
...
note = admin.memory_note(f"verify memory_export {suffix}: standing guidance, team-wide")
