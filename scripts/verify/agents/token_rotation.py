"""Verification: stored agent tokens — readable again and rotatable (design D19).
...
_agent, token = admin.register_agent(name, "claude-code", "verify agent", None, str(workdir))
...
as_agent.attach(DEAD_ENDPOINT, "verify-channel-token")
