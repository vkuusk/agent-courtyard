"""Verification: the Agents-page hub contract and the default a new line starts on.
...
hr("3. DEFAULTS  (the dial a NEW line starts on)")
...
print("\n(cleaned up the throwaway agents and the temp workdir.)")
