"""Verification: D24 — end shift closes the books; incidents re-deliver (design §8.1, §6.4).
...
_, a_token = admin.register_agent(a_name, "dummy", "verify sender")
b_agent, b_token = admin.register_agent(b_name, "dummy", "verify recipient")
...
summary = b.attach(DEAD_ENDPOINT, "verify-ct")  # "session 2" starts
...
summary = b.attach(DEAD_ENDPOINT, "verify-ct")
