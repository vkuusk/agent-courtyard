"""Verification: the team charter (design team-charter.md, D33) — the read path
...
Needs the compose postgres up (`make db-up`). Run:
    uv run python scripts/verify/charter/team_charter.py
"""
...
FIXTURE = Path(__file__).resolve().parents[3] / "tests" / "team-charter"
...
try:
    ...
    print("\n(throwaway hub stopped, scratch database dropped, scratch dir removed.)")
